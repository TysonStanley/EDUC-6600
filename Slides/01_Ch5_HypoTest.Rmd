...
.center[
## .dcoral[Causality] depends on .nicegreen[**evidence**] <br> from outside statistics:
]
...
.pull-left[ 
.center[
### .dcoral[**Null**] <br> Hypothesis <br> ]
$$H_0: \mu_1 = \mu_2$$
]

.pull-right[ 
.center[
### .nicegreen[**Research**  or Alternative] <br> Hypothesis options...]
$$H_1: \mu_1 \ne \mu_2$$
$$H_1: \mu_1 \lt \mu_2$$
$$H_1: \mu_1 \gt \mu_2$$
]
...
IF the p-value is very SMALL (p-value< a), it is UNLIKELY we would have observed a sample that extreme JUST DUE TO RANDOM CHANCE.
Can use the p-value< a   OR   test statistic < Critical Value
