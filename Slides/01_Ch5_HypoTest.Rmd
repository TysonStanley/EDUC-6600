...
- IF the sample is far from normal &/or small n, might want to transform variables
  - Look at plots: .dcoral[histogram, boxplot, & QQ plot] (straight 45º line)
...
<br><br>
- EX) A drug to lower temperature is found to reproducibly lower patient temperature by 0.4°Celsius, $p \lt 0.01$. But clinical benefits of temperature reduction only appear for a 1°decrease or larger. 
